...
config.participants.users.manufacturers[3] = {}
config.participants.users.manufacturers[3].company = 'Nihal Ansari Corp'
config.participants.users.manufacturers[3].type = 'Manufacturer'
config.participants.users.manufacturers[3].user = 'Nihal'
